...
public class RelativisarTest {
    public static void main(String[] args) {
        Path dir = Paths.get("/home/josias");
        Path classe = Paths.get("/home/josias/java/Pessoa.java");
        Path pathToClasse = dir.relativize(classe);
        System.out.println(pathToClasse);

        Path absoluto1 = Paths.get("/home/josias");
        Path absoluto2 = Paths.get("/usr/local");
        Path absoluto3 = Paths.get("/home/josias/java/Pessoa.java");
