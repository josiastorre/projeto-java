...
public class ExpressoesRegularesTest {
    public static void main(String[] args) {
        ...
        int hex = 0x1;
//        String regex = "0[xX]([0-9a=fA-F])+(\\s|s)";
//        String texto = "12 0x 0X 0x01FFABC 0x10G 0x1 ";
//        String regex = "([a-zA-Z0-9\\._-])+@([a-zA-Z])+(\\.([a-zA-Z])+)+"; // ([\\W\\._-])+@([a-zA-Z])+(\\.([a-zA-Z])+)+
//        String texto = "fulano@hotmail.com, 102abc@gmail.com, +g!abrao@gmail.br, teste@gmail.com.br, teste@mail";
...
//        String texto = "05/10/2010 05/05/2015 1/1/01 01/05/95"; //dd/MM/yyyy
        ...
        System.out.println("Email válido? "+"+g!abrao@gmail.br".matches(regex));
        Pattern pattern = Pattern.compile(regex);
        Matcher matcher = pattern.matcher(texto);
        System.out.println("texto:  " + texto);
        System.out.println("índice: 012345678901234567");
